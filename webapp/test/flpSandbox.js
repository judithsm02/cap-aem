		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Application Extension Advisory",
									"targetURL": "#capaemadvisoryui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"capaemadvisoryui5-display": {
								"semanticObject": "capaemadvisoryui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=capaemadvisoryui5",
									"url": sap.ui.require.toUrl("capaemadvisoryui5")
								}
							}
						}
					}
